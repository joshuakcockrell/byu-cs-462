...
//   }
//   else {
//     opts.email = 'joshuakcockrell@gmail.com';
//     opts.agreeTos = true;
//   }
...
// require('http').createServer(lex.middleware(require('redirect-https')())).listen(8888, function () {
...
// // handles your app
// require('https').createServer(lex.httpsOptions, lex.middleware(app)).listen(8000, function () {
